...
namespace DoctrineORMModule\Proxy\__CG__\EOSUser\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \EOSUser\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EOSUser\\Entity\\User' . "\0" . 'id', '' . "\0" . 'EOSUser\\Entity\\User' . "\0" . 'nome', '' . "\0" . 'EOSUser\\Entity\\User' . "\0" . 'email', '' . "\0" . 'EOSUser\\Entity\\User' . "\0" . 'password', '' . "\0" . 'EOSUser\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'EOSUser\\Entity\\User' . "\0" . 'active', '' . "\0" . 'EOSUser\\Entity\\User' . "\0" . 'activationKey', '' . "\0" . 'EOSUser\\Entity\\User' . "\0" . 'updateAt', '' . "\0" . 'EOSUser\\Entity\\User' . "\0" . 'createdAt');
        }
    ...
    public function setUpdateAt()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUpdateAt', array());
